...
class Reference extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            AdvancedNumber::make('Latitude', fn () => $this->location->getLatitude())->decimals(5)->copyable(), /** @phpstan-ignore-line */
            AdvancedNumber::make('Longitude', fn () => $this->location->getLongitude())->decimals(5)->copyable(), /** @phpstan-ignore-line */
    ...
    {
        return [
            new Actions\MarkReferenceSaved,
        ];
    }
}
