...
<html>
  ...
  <body>
    <form action="/" method="get">
        ...
        <label for="activited_this_year">Activated this year</label>
        <input type="checkbox" id="activited_this_year" name="filter[activited_this_year]">
    ...
    <script async
    src="https://maps.googleapis.com/maps/api/js?v=beta&key=AIzaSyBjZYYdCJxkqonGrjoBwdwZpZtOjpjHtuA&loading=async&callback=initMap&libraries=marker&apiOptions=MCYJ5E517XR2JC">
</script>
